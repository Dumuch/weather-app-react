...
const DashboardPropertiesCreateLocationModal: FunctionComponent<Props> = observer(
    ({
        isOpenModal,
        closeLocationModal,
        zip,
...
export default DashboardPropertiesCreateLocationModal;
