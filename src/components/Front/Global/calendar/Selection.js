    ...
    (0, _createClass2.default)(Selection, [
        ...
        },
        {
            ...
            value: function _addInitialEventListener() {
                var _this2 = this;
                let typeEvent = 'mousedown';
                if ('ontouchstart' in window) {
                    typeEvent = 'touchstart';
                }

                var removeMouseDownListener = addEventListener(typeEvent, function (e) {
                    _this2._removeInitialEventListener();
                    _this2._handleInitialEvent(e);

                    _this2._removeInitialEventListener = addEventListener(typeEvent, _this2._handleInitialEvent);
                });
        ...
        },
        {
            ...
            value: function _handleInitialEvent(e) {
                ...
                const clientX = _getEventCoordinates3.clientX;
                const clientY = _getEventCoordinates3.clientY;
                const pageX = _getEventCoordinates3.pageX;
                const pageY = _getEventCoordinates3.pageY;
        ...
        },
        {
            ...
            value: function _handleTerminatingEvent(e) {
                ...
                const pageX = _getEventCoordinates4.pageX;
                const pageY = _getEventCoordinates4.pageY;
