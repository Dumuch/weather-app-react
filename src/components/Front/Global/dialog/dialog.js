...
this.primereact.dialog = (function (exports, React, PrimeReact, csstransition, hooks, portal, ripple, utils) {
    ...
    var Dialog = /*#__PURE__*/ React__namespace.forwardRef(function (props, ref) {
        ...
        var focus = function focus() {
            ...
            var isActiveElementInDialog =
                activeElement && dialogRef.current && dialogRef.current.contains(activeElement);
        ...
        var onDragStart = function onDragStart(event) {
            if (
                utils.DomHandler.hasClass(event.target, 'p-dialog-header-icon') ||
                utils.DomHandler.hasClass(event.target.parentElement, 'p-dialog-header-icon')
            ) {
                return;
            }
        ...
        var disableDocumentSettings = function disableDocumentSettings() {
            ...
            if (props.modal) {
                var hasBlockScroll =
                    ...
                    document.primeDialogParams.some(function (param) {
        ...
        var bindGlobalListeners = function bindGlobalListeners() {
            ...
            if (props.closable) {
                ...
                document.primeDialogParams = document.primeDialogParams
                    ? [].concat(_toConsumableArray(document.primeDialogParams), [newParam])
                    : [newParam];
            }
        };
        ...
        var unbindGlobalListeners = function unbindGlobalListeners() {
            ...
            document.primeDialogParams =
                document.primeDialogParams &&
                document.primeDialogParams.filter(function (param) {
            ...
            if (!styleElement.current) {
                ...
                for (var breakpoint in props.breakpoints) {
                    innerHTML += '\n                    @media screen and (max-width: '
                        .concat(breakpoint, ') {\n                        .p-dialog[')
                        .concat(attributeSelector.current, '] {\n                            width: ')
                        .concat(
            ...
            function () {
                if (maskVisibleState) {
                    utils.ZIndexUtils.set(
                        ...
                        props.baseZIndex || PrimeReact__default['default'].zIndex['modal']
                    );
        ...
        var createElement = function createElement() {
            ...
            var maskClassName = utils.classNames(
                'p-dialog-mask',
                getPositionClass(),
                {
            ...
            var transitionTimeout = {
                enter: props.position === 'center' ? 450 : 450,
                exit: props.position === 'center' ? 450 : 450,
            };
            return /*#__PURE__*/ React__namespace.createElement(
                'div',
                {
