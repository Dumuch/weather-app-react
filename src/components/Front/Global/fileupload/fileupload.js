...
this.primereact.fileupload = (function (exports, React, api, button, messages, progressbar, ripple, utils) {
    ...
    var FileUpload = /*#__PURE__*/ React__namespace.memo(
        /*#__PURE__*/ React__namespace.forwardRef(function (props, ref) {
            ...
            var chooseDisabled =
                disabled || (props.fileLimit && props.fileLimit <= filesState.length + uploadedFileCount);
            ...
            var onDrop = function onDrop(event) {
                ...
                var allowDrop =
                    props.multiple || (utils.ObjectUtils.isEmpty(filesState) && files && files.length === 1);
            ...
            var createChooseButton = function createChooseButton() {
                ...
                var chooseClassName = utils.classNames(
                ...
                var icon = utils.IconUtils.getJSXIcon(
                    _icon || 'pi pi-fw pi-plus',
                    {
            ...
            var createFile = function createFile(file, index) {
                ...
                var preview = isImage(file)
                    ...
                    : null;
                var fileName = /*#__PURE__*/ React__namespace.createElement(
                    'div',
                    {
                ...
                var removeButton = /*#__PURE__*/ React__namespace.createElement(
                    'div',
                    null,
                ...
                var content = /*#__PURE__*/ React__namespace.createElement(
            ...
            var createEmptyContent = function createEmptyContent() {
                return props.emptyTemplate && !hasFiles
                    ? utils.ObjectUtils.getJSXElement(props.emptyTemplate, props)
                    : null;
            };
            ...
            var createAdvanced = function createAdvanced() {
                ...
                var header = /*#__PURE__*/ React__namespace.createElement(
                    'div',
                    {
                ...
                return /*#__PURE__*/ React__namespace.createElement(
                    ...
                    /*#__PURE__*/ React__namespace.createElement(
                        ...
                        progressBar,
                        /*#__PURE__*/ React__namespace.createElement(messages.Messages, {
                            ref: messagesRef,
                        }),
                        filesList,
                        emptyContent
            ...
            var createBasic = function createBasic() {
                ...
                var buttonClassName = utils.classNames(
                ...
                var labelClassName = 'p-button-label p-clickable';
                var chooseLabel = chooseOptions.iconOnly
                    ? /*#__PURE__*/ React__namespace.createElement('span', {
                          className: labelClassName,
                          dangerouslySetInnerHTML: {
                              __html: '&nbsp;',
