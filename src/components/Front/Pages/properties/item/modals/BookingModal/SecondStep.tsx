...
const SecondStep: FC<Props> = observer(({ reservationData, propertyId, proceedToNextStep, setIsNextStepLoading }) => {
                            ...
                            return (
                                <Form id="bookingStep2">
                                    ...
                                    <div className="textbox">
                                        <p>
                                            By clicking the &quot;BOOK NOW&quot; button below, you agree to have the
                                            total reservation amount charged to your payment method entered here in
                                            accordance with BidBookStay.com&apos;s policies, procedures, and Terms &
                                            Conditions. Click the &quot;BOOK NOW&quot; button to proceed with booking
                                            your stay.
                                        </p>
                                    </div>
                                </Form>
                                            ...
                                            <ProfileSectionPaymentUpdateCardModal
                                                tooltip={
                                                    <>
                                                        ...
                                                        expiration date, please use the form below. <br />
                                                        <br />
                                                        To use a different payment method, go to the <br />
                                                        &quot;Payment info&quot; tab on your profile, delete the
                                                        <br /> current card, and add a new one.
                                                    </>
                                                }
